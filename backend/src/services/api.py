...
class ServerAPI(Thread):
    ...
    def __init__(self, host='0.0.0.0', port=8080):
        ...
        @self.app.route('/session/<int:session_id>', methods=['GET'])
        ...
        @self.app.route('/session/<int:session_id>', methods=['POST'])
        ...
        @self.app.route('/session/<int:session_id>/allParticipants', methods=['POST'])
        ...
        @self.app.route('/question/<string:collection>/<string:question_id>')
        ...
        @self.app.route('/question/<string:collection>/<string:question_id>/image')
        ...
        # Crear una sesión
        @self.app.route('/createSession', methods=['POST'])
        ...
        @self.app.route('/downloadLog/<path:zip_filename>')
        ...
        @self.app.route('/downloadAllLogs')
        ...
        @self.app.route('/downloadAllTrajectories')
        ...
        @self.app.route('/deleteAllTrajectories')
